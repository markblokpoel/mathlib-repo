...
val outputsSI4 = inputs.map(input =>
  SelectingInvitees.si4(
    input.group,
    input.personsLiked,
...
val outputsSI5 = inputs.map(input =>
  SelectingInvitees.si5(
    input.group,
    input.personsLiked,
    input.personsDisliked,
    input.like
...
val outputsSI6 = inputs.map(input =>
  SelectingInvitees.si6(
    input.group,
    input.personsLiked,
    input.personsDisliked,
    input.like,
